...
import com.diabin.latte.ec.main.settings.AboutDelegate;
import com.diabin.latte.ec.main.settings.SettingsClickListener;
...
public class SettingsDelegate extends LatteDelegate {
    ...
    public void onBindView(@Nullable Bundle savedInstanceState, @NonNull View rootView) {
        ...
        final ListBean push = new ListBean.Builder()
                ...
                .setId(1)
//                .setDelegate(new com.diabin.latte.ec.main.personal.address.AddressDelegate())
