...
public class KejianWvDelegate extends LatteDelegate {
    ...
    private void initImages() {
        ...
        if (arguments != null) {
            ...
            if (pictures != null) {
                ...
                final WvKejianAdapter adapter = new WvKejianAdapter(entities);
    ...
    public static KejianWvDelegate create(ArrayList<String> pictures) {
        final Bundle args = new Bundle();
        args.putStringArrayList(ARG_PICTURES, pictures);
        final KejianWvDelegate delegate = new KejianWvDelegate();
